                                            ...
                                            <div class="d-none popover-custom-content">
                                                <div class="dropdown-menu-header">
                                                    <div class="dropdown-menu-header-inner bg-tempting-azure">
                                                        <div class="menu-header-image opacity-1" style="background-image: url('<?php echo base_url() ?>tools/assets/images/dropdown-header/city5.jpg');"></div>
                            ...
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-left mr-3">
                                        <div class="widget-content-left"><img width="42" class="rounded" src="<?php echo base_url() ?>tools/assets\images\avatars\1.jpg" alt=""></div>
                                    </div>
                                    <div class="widget-content-left">
                                ...
                                <div class="vertical-timeline-element-content bounce-in">
                                    <h4 class="timeline-title">Something not important
                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                            ...
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img src="<?php echo base_url() ?>tools/assets\images\avatars\6.jpg" alt=""></div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img src="<?php echo base_url() ?>tools/assets\images\avatars\7.jpg" alt=""></div>
                                            </div>
...
<div class="app-drawer-overlay d-none animated fadeIn"></div><script type="text/javascript" src="<?php echo base_url() ?>tools/assets/scripts/main.js"></script>
<script src="<?php echo base_url() ?>tools/js/custom.js"></script>
<script src="<?php echo base_url() ?>tools/assets/scripts/jquery.min.js"></script>
