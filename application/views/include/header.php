...
<link href="<?php echo base_url() ?>/tools/assets/css/main.css" rel="stylesheet"></head>
<body>
...
<?php  
    ...
    echo $url;  
    if($url=="http://localhost/pfe/school/classes"){
        require 'modal2.php';
    }else if ($url=="http://localhost/pfe/school/category"){
        require 'modal.php';
    }else if ($url=="http://localhost/pfe/student/student_registration"){
        require 'modal3.php';
        require 'modalinfo.php';
    }else  if ($url=="http://localhost/pfe/staff/manage_staff"){
        require 'modal4.php';
    }
  ?>   
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-secondary">
                                    <div class="menu-header-image opacity-5" style="background-image: url('<?php echo base_url() ?>tools/assets/images/dropdown-header/abstract2.jpg');"></div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-rounded dropdown-menu-lg rm-pointers dropdown-menu">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-success">
                                    <div class="menu-header-image opacity-1" style="background-image: url('<?php echo base_url() ?>tools/assets/images/dropdown-header/abstract3.jpg');"></div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu dropdown-menu-right">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-plum-plate">
                                    <div class="menu-header-image" style="background-image: url('<?php echo base_url() ?>tools/assets/images/dropdown-header/abstract4.jpg');"></div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu dropdown-menu-right">
                            <div class="dropdown-menu-header mb-0">
                                <div class="dropdown-menu-header-inner bg-deep-blue">
                                    <div class="menu-header-image opacity-1" style="background-image: url('<?php echo base_url() ?>tools/assets/images/dropdown-header/city3.jpg');"></div>
                                                                    ...
                                                                    <h4 class="timeline-title">Something not important
                                                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img src="<?php echo base_url() ?>tools/assets\images\avatars\1.jpg" alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img src="<?php echo base_url() ?>tools/assets\images\avatars\2.jpg" alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img src="<?php echo base_url() ?>tools/assets\images\avatars\3.jpg" alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img src="<?php echo base_url() ?>tools/assets\images\avatars\4.jpg" alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img src="<?php echo base_url() ?>tools/assets\images\avatars\5.jpg" alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img src="<?php echo base_url() ?>tools/assets\images\avatars\9.jpg" alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img src="<?php echo base_url() ?>tools/assets\images\avatars\7.jpg" alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img src="<?php echo base_url() ?>tools/assets\images\avatars\8.jpg" alt=""></div>
                                                                            </div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu dropdown-menu-right">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
                                    <div class="menu-header-image opacity-05" style="background-image: url('<?php echo base_url() ?>tools/assets/images/dropdown-header/city2.jpg');"></div>
                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="<?php echo base_url() ?>tools/assets\images\avatars\1.jpg" alt="">
                                        <i class="fa fa-angle-down ml-2 opacity-8"></i>
                                    </a>
                                    <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right">
                                        <div class="dropdown-menu-header">
                                            <div class="dropdown-menu-header-inner bg-info">
                                                <div class="menu-header-image opacity-2" style="background-image: url('<?php echo base_url() ?>tools/assets/images/dropdown-header/city3.jpg');"></div>
                                                <div class="menu-header-content text-left">
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                            ...
                            <!--<li class="theme-settings-swatches d-none list-group-item">
                                ...
                                <div class="swatch-holder swatch-holder-img active">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url() ?>tools/assets/images/sidebar/city1.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url() ?>tools/assets/images/sidebar/city2.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url() ?>tools/assets/images/sidebar/city3.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url() ?>tools/assets/images/sidebar/city4.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url() ?>tools/assets/images/sidebar/city5.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url() ?>tools/assets/images/sidebar/abstract1.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url() ?>tools/assets/images/sidebar/abstract2.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url() ?>tools/assets/images/sidebar/abstract3.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url() ?>tools/assets/images/sidebar/abstract4.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url() ?>tools/assets/images/sidebar/abstract5.jpg">
                                    </a>
                                </div>
                            </li>-->
                        </ul>
                ...
                <div class="app-header__menu">
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url() ?>school/category">
                            ...
                            <li>
                                <a href="<?php echo base_url() ?>student/student_registration">
                                    <i class="metismenu-icon pe-7s-study">
                                    </i>Étudiants
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url() ?>staff/manage_staff">
