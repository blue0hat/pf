                    ...
                    <div class="tabs-animation">
                        <div class="mb-3 card">
                            ...
                            <div class="text-center d-block p-3 card-footer">
                                <button data-toggle="modal" data-target=".bd-example-modal-lg" class="btn-pill btn-shadow btn-wide fsize-1 btn btn-primary btn-lg">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-left mr-3">
                                                                    <div class="widget-content-left">
                                                                        <img width="42" class="rounded" src="<?php echo base_url() ?>tools/assets\images\avatars\1.jpg" alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="widget-content-left">
                                                        ...
                                                        <div>
                                                            <div class="avatar-icon-wrapper mr-1">
                                                                ...
                                                                <div class="avatar-icon avatar-icon-lg rounded">
                                                                    <img src="<?php echo base_url() ?>tools/assets\images\avatars\2.jpg" alt="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div>
                                                        ...
                                                        <div class="chat-box-wrapper chat-box-wrapper-right">
                                                            ...
                                                            <div>
                                                                <div class="avatar-icon-wrapper ml-1">
                                                                    <div class="badge badge-bottom btn-shine badge-success badge-dot badge-dot-lg"></div>
                                                                    <div class="avatar-icon avatar-icon-lg rounded">
                                                                        <img src="<?php echo base_url() ?>tools/assets\images\avatars\3.jpg" alt="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
